...
<head>
    ...
    <title>News Carousel - Bootsnipp.com</title>
    ...
    <style type="text/css">
        ...
        /*--760x400 img/*/ 
        .responsiveimg{    overflow: hidden;display: block;
...
<body>
	...
	<?php 
		...
		if(count($texto)!=0  && mysqli_num_rows($texto)>=2){
			echo "<div='container'><div class='carousel slide' data-ride='carousel' id='myCarousel'>";
			while($noticiaslider = mysqli_fetch_array($texto)){
				
                echo "<div class='carousel-inner'>
                        <div class='item active'> 
                            <img src='".$noticiaslider['3']."' alt='imagen noticia' class='responsiveimg'/>
                                <div class='carousel-caption' ><h4>".cortar($noticiaslider['1'],50)."</h4>
...
<div class="container">
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="img/foto1.jpg" class="responsiveimg">
         ...
         <div class="item">
          <img src="img/foto4.png" class="responsiveimg">
           <div class="carousel-caption">
        ...
        <div class="item">
          <img src="img/foto2.jpeg" class="responsiveimg">
           <div class="carousel-caption">
        ...
        <div class="item">
          <img src="img/foto3.jpg" class="responsiveimg">
           <div class="carousel-caption">
