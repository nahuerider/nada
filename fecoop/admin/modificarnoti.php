	...
	<section class="oja">
		...
		<?php
			...
			if(!empty($fila)){
				...
				echo "<section class='secnoti'><form method='POST' action='updatenoti.php?noticia=".$fila['0']."' enctype='multipart/form-data'><h2>Titulo</h2><input class='ingr' maxlength='70' type='text' type='text' value='".$fila['1']."' name='titulo' required /><div class='popup' onclick='myFunction()'><span class='popuptext' id='myPopup'>Este es el titulo que aparece en el contenedor de noticia, es obligatorio</span></div><h2>Sinopsis de la noticia</h2><textarea class='ingr' class='ingr' name='sinop' required maxlength='300' >".$fila['3']."</textarea><div class='popup' onclick='myFunction2()'><span class='popuptext' id='myPopup2'>Esta es la sinopsis de la noticia que aparece en el contenedor de noticia,es obligatorio</span></div><h2>Cuerpo de la noticia</h2><div class='popup' onclick='myFunction3()'><span class='popuptext' id='myPopup3'>Este es el cuerpo que aparece al seleccionar la opcion de 'LEER MAS',es obligatorio</span></div><textarea id='summernote' name='noticia' required>".$fila['2']."</textarea><div class='user3'><h2 class='mensaje'>Portada</h2><input type='file' id='files' name='files'><output id='list'></output></div><div class='popup' onclick='myFunction4()'><span class='popuptext' id='myPopup4'>Esta es la imagen que aparece en el contenedor de la noticia, es obligatorio</span></div><hr class='altalinea'><h2 class='mensaje'>Tamaño de la noticia</h2><div class='popup' onclick='myFunction5()'><span class='popuptext' id='myPopup5'>Selecciona el tamaño del contenedor de noticia, es obligatorio, si la imagen se encuentra deforme en la previsualizacion</span></div><hr class='altalinea'><table style='margin:4%;width: 100%;font-size: 25px;'><tr><td><label style='margin-right: 10%;'><input type='radio' value='0' name='tamano' required />Grande</label></td><td></td><td><label style='margin-right: 10%;'><input type='radio' value='1' name='tamano' required />Pequeño</label></td></tr></table><hr class='altalinea'><h2 class='mensaje'>Aparicion de la noticia</h2><hr class='altalinea'><table style='margin:4%;width: 100%;font-size: 25px;'><tr><td><label style='margin-right: 10%;'><input type='checkbox' value='1' name='destacada' ".$fijate."/>Insertar en primera pagina</label><div class='popup' onclick='myFunction6()'><span class='popuptext' id='myPopup6'>Aparece en la primera pagina</span></div></td><td><label style='margin-right: 10%;'><input type='checkbox' value='1' name='actividad' ".$fijate2."/>Insertar en actividades</label><div class='popup' onclick='myFunction8()'><span class='popuptext' id='myPopup8'>Aparece como actividad en la solapa de'Sobre Nosotros'</span></div></td><td><label style='margin-right: 10%;'><input type='checkbox' value='1' name='slider' ".$fijate3."/>Insertar en el carrusel</label><div class='popup' onclick='myFunction7()'><span class='popuptext' id='myPopup7'>Aparece en el carrusel de la primera pagina</span></div></td></tr></table><hr><label class='fecha'>Fecha:</label><input id='date' type='date' name='fecha' value='".$nuevafecha."'><div class='popup' onclick='myFunction9()'><span class='popuptext' id='myPopup9'>La fecha aparece en el contenedor de la noticia, es obligatorio</span></div><hr><p class='fecha'>Selecciona relevancia</p><select class='fecha' name='prioridad'><option class='fecha' value='max'>Maxima</option><option class='fecha' value='med'>Media</option><option class='fecha' value='min'>Minima</option><option class='fecha' value='none'>Ninguna</option></select><hr>";
				...
				$obtener1=mysqli_query($con,$consulta) or die(mysqli_error($con));
						...
						echo "<div class='popup' onclick='myFunction10()'><span class='popuptext' id='myPopup10'>Al momento de LEER MAS una noticia debajo apareceran los entes relacionados con la noticia</span></div>";
