	...
	<section class="oja">
		...
		<?php
			...
			if(!empty($fila)){
				...
				echo "<form action='updatedoc.php?doc=".$fila['0']."' method='POST' enctype='multipart/form-data'><section style='margin-top: 10%;'  class='sec'><select style='margin: 3%;font-size: 20px;' name='categoria' required><option value='0'>Seleccione tipo de documento</option><option value='1' ".$fijate." >Documento</option><option value='2'	".$fijate2.">Legislacion</option></select><div class='popup' onclick='myFunction()'><span class='popuptext' id='myPopup'>Se debe seleccionar el tipo de archivo que se subira</span></div><hr><div style='margin: 3%;font-size: 20px;'><input type='file' name='doc' required value='".$fila['2']."' /><a href='".$fila['2']."'>VER DOC</a><div class='popup' onclick='myFunction2()'><span class='popuptext' id='myPopup2'>Debe elegir el archivo a subir</span></div><label class='hello'>Nombre del archivo:</label><input type='text' name='nombre' maxlength='50' class='haters' required value='".$fila['1']."'/><div class='popup' onclick='myFunction3()'><span class='popuptext' id='myPopup3'>Este es el nombre con el cual aparecera el archivo, es obligatorio</span></div></div><hr><div class='botons'><input class='canc' type='button' value='Cancelar' onclick='window.history.back()' name='action'/><input type='submit' class='boton' value='Cargar'/></div></section></form>";
			}else{
