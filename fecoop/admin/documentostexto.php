	...
	<section class="oja">
		...
		<form action="updatetextdoc.php" method="POST">
			...
			<div class="popup" onclick="myFunction()">
				<span class="popuptext" id="myPopup">Este editor corresponde al texto que se encuentra antes de la lista de documentos </span>
			</div>
			...
			<div class="popup" onclick="myFunction2()">
				<span class="popuptext" id="myPopup2">Este editor corresponde al texto que se encuentra antes de la lista de legislaciones </span>
			</div>
