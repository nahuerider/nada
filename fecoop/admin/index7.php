...
<html>
	...
	<section class="oja">
		...
		<div class="quickbar">
				<div class="quickbar2">
					<a href="crearasociado.php?cate=1" class="quickoption"><i class="fa fa-plus-square fa-3x" id="quickmas"></i></a>
					<a href="modificarasociado.php" class="quickoption"><i class="fa fa-pencil fa-3x" id="quickmas"></i></a>
					<a href="eliminarasociados.php" class="quickoption"><i class="fa fa-minus-square fa-3x" id="quickmas"></i></a>
				</div>
			</div>	
		<?php
