					...
					<form action="saveasociado.php?cate=<?php echo $_GET['cate']; ?>" method="POST" enctype="multipart/form-data">
						<div class="agru">
							...
							<div class="popup" onclick="myFunction()">
								<span class="popuptext" id="myPopup">El nombre del vinculo/coopteba es obligatorio ya que aparece en el contenedor, pero la matricula no </span>
							</div>
						</div>
						
						<div class="user56"><h2 class="mensaje">Logo de Coopteba o Vinculo</h2><input type="file" name="logo" id="files" name="files[]" required /><output id="list"></output></div><div class="popup" onclick="myFunction2()"><span class="popuptext" id="myPopup2">El logo es obligatorio ya que aparece en el contenedor de vinculos/cooptebas </span></div>
						...
						<div class="extras">
								<div class="usercontac">
									...
									<div class="popup" onclick="myFunction3()">
										<span class="popuptext" id="myPopup3">Estos elementos son opcionales y se muestran a la hora de ver un vinculo/coopteba y no aparecen si estan vacios </span>
									</div>
								</div>
								...
								<div class="popup" onclick="myFunction4()">
									<span class="popuptext" id="myPopup4">Este mapa aparece al ver un vinculo/coopteba, es completamente opcional y no aparece si no tiene un marcador </span>
								</div>
						</div>
