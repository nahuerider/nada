...
<head>
	...
	<section class="oja">
		...
		<div class="quickbar">
			<div class="quickbar2">
				<a href="guardardocumento.php" class="quickoption"><i class="fa fa-plus-square fa-3x" id="quickmas"></i></a>
				<a href="modificardocumento.php" class="quickoption"><i class="fa fa-pencil fa-3x" id="quickmas"></i></a>
				<a href="eliminardoc.php" class="quickoption"><i class="fa fa-minus-square fa-3x" id="quickmas"></i></a>
			</div>
		</div>		
		...
		<?php
						...
						if(count($texto)!=0 or count($texto2)!=0){
							echo "<section class='documentos'><div><h2 class='encabezao'><img src='icons/documentos.png' class='iconitos'/>Documentos<div class='icon'><a href='documentostexto.php'><i id='edi' class='fa fa-pencil'></i></a></div></h2>";
					...
					<?php
							...
							if(count($legis)!=0 or count($texto4)){
								echo "<section class='texin'><div><h2 class='encabezao'><img src='icons/legislacion.png' class='iconitos'/>Legislacion<div class='icon'><a href='documentostexto.php'><i id='edi' class='fa fa-pencil'></i></a></div></h2>";
								if(!empty($legis['0'])){
