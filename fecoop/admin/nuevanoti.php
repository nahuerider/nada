		...
		<section class="secnoti">
			<form method="POST" action="guardar.php" enctype="multipart/form-data">
				...
				<div class="popup" onclick="myFunction()">
					<span class="popuptext" id="myPopup">Este es el titulo que aparece en el contenedor de noticia, es obligatorio</span>
				</div>
				...
				<div class="popup" onclick="myFunction2()">
					<span class="popuptext" id="myPopup2">Esta es la sinopsis de la noticia que aparece en el contenedor de noticia,es obligatorio</span>
				</div>
				<h2 style="margin-top:5%;">Cuerpo de la noticia</h2>
				<div class="popup" onclick="myFunction3()">
					<span class="popuptext" id="myPopup3">Este es el cuerpo que aparece al seleccionar la opcion de "LEER MAS",es obligatorio</span>
				</div>
				...
				<div class="popup" onclick="myFunction4()">
					<span class="popuptext" id="myPopup4">Esta es la imagen que aparece en el contenedor de la noticia, es obligatorio</span>
				</div>
				<hr class="altalinea">
				<h2 class="mensaje">Tamaño de la noticia</h2>
				<div class="popup" onclick="myFunction5()">
					<span class="popuptext" id="myPopup5">Selecciona el tamaño del contenedor de noticia, es obligatorio, si la imagen se encuentra deforme en la previsualizacion</span>
				</div>
				<hr class="altalinea">
				...
				<table style="margin:4%;width: 100%;font-size: 25px;">
					<tr>
						<td><label style="margin-right: 10%;"><input type="checkbox" value="1" name="destacada"/>Insetar en primera pagina</label><div class="popup" onclick="myFunction6()"><span class="popuptext" id="myPopup6">Aparece en la primera pagina</span></div></td>
						<td><label style="margin-right: 10%;"><input type="checkbox" value="1" name="actividad"/>Insertar a las actividades</label><div class="popup" onclick="myFunction7()"><span class="popuptext" id="myPopup7">Aparece como actividad en la solapa de"Sobre Nosotros"</span></div></td>
						<td><label style="margin-right: 10%;"><input type="checkbox" value="1" name="slider"/>Insertar en el carrusel de noticias</label><div class="popup" onclick="myFunction8()"><span class="popuptext" id="myPopup8">Aparece en el carrusel de la primera pagina</span></div></td>
					</tr>
				</table>
				<hr class="altalinea">
				<label class="fecha" style="margin-right: 2%;">Fecha:</label><input id="date" type="date" name="fecha">
				<div class="popup" onclick="myFunction9()">
					<span class="popuptext" id="myPopup9">La fecha aparece en el contenedor de la noticia, es obligatorio</span>
				</div>
				<hr class="altalinea">
				...
				<div class="popup" onclick="myFunction10()">
					<span class="popuptext" id="myPopup10">Al momento de LEER MAS una noticia debajo apareceran los entes relacionados con la noticia</span>
				</div>
				<div class="botons">
