	...
	<section class="oja">
		...
		<form method="POST" action="deletedoc.php">
			...
			<div class="popup" onclick="myFunction()">
				<span class="popuptext" id="myPopup">Para eliminar un documento/legislacion solo basta con tildarlo y clickear en Enviar, se pueden seleccionar un documentos y legislaciones al mismo tiempo</span>
			</div>
			<div class="botons">
