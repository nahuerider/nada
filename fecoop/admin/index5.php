...
<html>
	...
	<section class="oja">
		...
		<div class="quickbar">
				<div class="quickbar2">
					<a href="nuevanoti.php" class="quickoption"><i class="fa fa-plus-square fa-3x" id="quickmas"></i></a>
					<a href="modificarnoticia.php" class="quickoption"><i class="fa fa-pencil fa-3x" id="quickmas"></i></a>
					<a href="eliminarnoticia.php" class="quickoption"><i class="fa fa-minus-square fa-3x" id="quickmas"></i></a>
				</div>
			</div>	
		<br>
		<?php
