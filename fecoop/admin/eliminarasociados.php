	...
	<section class="oja">
		...
		<form method="POST" action="deleteasociados.php">
				...
				<div class="popup" onclick="myFunction()">
					<span class="popuptext" id="myPopup">Para eliminar un vinculo/coopteba solo basta con tildarlo y clickear en Enviar, se pueden seleccionar un vinculos y cooptebas al mismo tiempo </span>
				</div>
