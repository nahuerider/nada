		...
		<div >
		   ...
		   <?php
				...
				if(empty($fila)){
					...
					if(!empty($fila['6'])){
							if(detectarURL($fila['6'])){
								echo "<span class='spandata'><img class='icondata' src='img/www2.png'><p class='pdata'>Pagina Web:<a href='".$fila['6']."' target='_blank'>Click Aqui</a></p></span>"; 
							}else{
					...
					if(!empty($fila['9'])){
						if(detectarURL($fila['9'])){
							echo "<span class='spandata'><img class='icondata' src='img/facebook.png'><p class='pdata'>Facebook:<a href='".$fila['9']."' target='_blank'>Click Aqui</a></p></span>"; 
						}else{
					...
					if(!empty($fila['10'])){
						if(detectarURL($fila['10'])){
							echo "<span class='spandata'><img class='icondata' src='img/twitter.png'><p class='pdata'>Twitter:<a href='".$fila['10']."' target='_blank'>Click Aqui</a></p></span>";
						}else{
					...
					if(!empty($fila['11'])){
						if(detectarURL($fila['11'])){
							echo "<span class='spandata'><img class='icondata' src='img/insta.png'><p class='pdata'>Instagram:<a href='".$fila['11']."' target='_blank'>Click Aqui</a></p></span>"; 
						}else{
					...
					if(!empty($fila['12'])){
						if(detectarURL($fila['12'])){
							echo "<span class='spandata'><img class='icondata' src='img/yotube.png'><p class='pdata'>Youtube:<a href='".$fila['12']."' target='_blank'>Click Aqui</a></p></span>"; 
						}else{
