	...
	<section class="oja">
		...
		<form action="createcomision.php" method="POST">
			...
			<div class="popup" onclick="myFunction2()">
				<span class="popuptext" id="myPopup2">Este es el nombre de la comision que aparera en la pestaña de "Comision" </span>
			</div>
			<textarea id="summernote" name="contentcomision" class="ingr" required ></textarea>
			<div class="popup" onclick="myFunction()">
				<span class="popuptext" id="myPopup">Este es el detalle que va debajo del cuadro de comision </span>
			</div>
